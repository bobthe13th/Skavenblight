...
//The tutorial made the example armor trimmable, so i guess ill make ours trimmable too
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.WARPSTONE_HELMET);
        trimmedArmorItem(ModItems.WARPSTONE_CHESTPLATE);
    ...
    // Shoutout to El_Redstoniano and Kaupenjoe for making this!
    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = Skavenblight.MODID;
